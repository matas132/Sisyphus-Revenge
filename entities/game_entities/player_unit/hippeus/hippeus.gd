...
const PETRIFIED = preload("res://assets/Entities/player units cards/petrified/GameJam-ControlledChaos-Unit-Ally-Hippeus-Petrified-Small.png")
const DAMAGED = preload("res://assets/Entities/player units cards/half_health/GameJam-ControlledChaos-Unit-Ally-Hippeus-Damaged-Small.png")

func _ready() -> void:
	 #SFX/Unit/AttackHitPierce
